/* ===== app.min.js (index/quiz/result; support Advanced A/B/C) ===== */
(function () {
  "use strict";
  ...
  function initResultBasic(){
    ...
    const c=$("#distChart");
    if (window.Chart && c?.getContext){
      new Chart(c.getContext("2d"), {
        type:"bar",
        data:{ labels:["非常同意A","較同意A","中立","較同意B","非常同意B"], datasets:[{ label:"作答分布（題數）", data:[dist["-2"],dist["-1"],dist["0"],dist["1"],dist["2"]] }] },
  ...
  // 暴露給全域（probe 用）
  window.App = { boot, initIndex, initQuiz, initResultBasic, initResultAdvanced, version: "2025-09-13-ABC" };
})();
